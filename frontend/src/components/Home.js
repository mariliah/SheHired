...
export default function Home() {
  return (
    <section className="w-full h-auto bg-cream font-poppins">
      <header>
        <nav className="flex justify-between items-center relative top-0">
          <img src={Logo} alt="shehired brand logo" />
          <ul className="w-3/20 flex justify-evenly items-center px-4 py-0">
            <li className="mx-6">
            ...
            <li className="mx-6">
              <button className="w-24 h-11 rounded-3xl bg-cream text-frostyMist font-bold bg-crimson hover:bg-crimson hover:text-frostyMist">
                Sign In
              </button>
            </li>
          </ul>
      ...
      <section className="w-full h-screen text-center">
        <h1 className="text-5xl text-slate">
          Where Women Thrive Professionally
        </h1>
        <p className="font-montserrat text-2xl text-slate">
          Access Diversity Equity Transparency: Your Inclusive Path Starts Here
        </p>
        <section className="flex justify-evenly items-center w-1/2 mx-auto">
