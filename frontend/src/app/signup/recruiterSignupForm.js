...
import { emailValidator, passwordValidator } from '../../composables/loginFormValidation'; 
      ...
      <section>
        {!submitted ? (
          <section className="w-full md:block py-20 font-poppins mx-12">
            <h1 className="font-bold text-2xl">CREATE A NEW COMPANY ACCOUNT</h1>
            ...
            <form className="flex flex-col mt-10" onSubmit={handleSubmit}>
              <div className="input-container relative w-full">
                ...
                <input
                  id="name"
                  type="text"
                  className={`w-full bg-cream pr-4 py-2 pl-10 bg-cream rounded-10 border-2 border-grey ${
